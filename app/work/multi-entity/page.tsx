            ...
            <div className="pp-point-art reveal">
              <div className="pp-card">
                ...
                <div className="pp-je">
                  ...
                  <div className="pp-je-row"><span className="pp-je-side cr">CR</span><span className="pp-je-acct">Cumulative translation adjustment<small>equity · not earnings</small></span><span className="pp-num">$63,750</span></div>
